...
namespace IIS.Kurs2
{
    ...
    [View("ЗагрФайлаE", new string[] {
            ...
            "ЭксФайлы as \'Экс файлы\'",
            "ЭксФайлы.Имя as \'Имя\'",
            "ЭксФайлы.Дата as \'Дата\'",
            "ЭксФайлы.Репозиторий as \'Репозиторий\'"}, Hidden=new string[] {
            "ЭксФайлы.Имя"})]
    [MasterViewDefineAttribute("ЗагрФайлаE", "ЭксФайлы", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Имя")]
    ...
    public class ЗагрФайла : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kurs2.ЭксФайлы fЭксФайлы;
        ...
        [PropertyStorage(new string[] {
                "ЭксФайлы"})]
        [NotNull()]
        public virtual IIS.Kurs2.ЭксФайлы ЭксФайлы
        {
            get
            {
                ...
                IIS.Kurs2.ЭксФайлы result = this.fЭксФайлы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗагрФайлаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗагрФайлаE", typeof(IIS.Kurs2.ЗагрФайла));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗагрФайлаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗагрФайлаL", typeof(IIS.Kurs2.ЗагрФайла));
                }
            }
        }
    }
