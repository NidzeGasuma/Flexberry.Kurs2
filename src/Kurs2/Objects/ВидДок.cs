    ...
    public class ВидДок : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ВидДокE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВидДокE", typeof(IIS.Kurs2.ВидДок));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ВидДокL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВидДокL", typeof(IIS.Kurs2.ВидДок));
                }
            }
        }
    }
