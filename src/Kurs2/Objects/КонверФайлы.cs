...
namespace IIS.Kurs2
{
    ...
    public class КонверФайлы : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kurs2.ВыгрФайла fВыгрФайла;
        ...
        [PropertyStorage(new string[] {
                "ВыгрФайла"})]
        [NotNull()]
        public virtual IIS.Kurs2.ВыгрФайла ВыгрФайла
        {
            get
            {
                ...
                IIS.Kurs2.ВыгрФайла result = this.fВыгрФайла;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонверФайлыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонверФайлыE", typeof(IIS.Kurs2.КонверФайлы));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КонверФайлыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонверФайлыL", typeof(IIS.Kurs2.КонверФайлы));
                }
            }
        }
    }
