...
namespace IIS.Kurs2
{
    ...
    public class ЭксФайлы : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kurs2.Расширение fРасширение;
        ...
        [PropertyStorage(new string[] {
                "ЕдиИзм"})]
        [NotNull()]
        public virtual IIS.Kurs2.ЕдиИзм ЕдиИзм
        {
            get
            {
                ...
                IIS.Kurs2.ЕдиИзм result = this.fЕдиИзм;
        ...
        [PropertyStorage(new string[] {
                "Расширение"})]
        [NotNull()]
        public virtual IIS.Kurs2.Расширение Расширение
        {
            get
            {
                ...
                IIS.Kurs2.Расширение result = this.fРасширение;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЭксФайлыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЭксФайлыE", typeof(IIS.Kurs2.ЭксФайлы));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЭксФайлыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЭксФайлыL", typeof(IIS.Kurs2.ЭксФайлы));
                }
            }
        }
    }
